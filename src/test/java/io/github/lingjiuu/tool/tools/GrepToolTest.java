...
public class GrepToolTest extends TestCase {
    ...
    public void testDescriptionNamesLimitsAndReadFollowUp() {
        String description = new GrepTool(WorkspaceAccessPolicy.rootedAt(Path.of("."))).description();
    ...
    public void testRespectsGitignore() throws Exception {
        ...
        ToolResultMessage result = execute(new GrepTool(WorkspaceAccessPolicy.rootedAt(root)), "{\"pattern\":\"needle\"}");
