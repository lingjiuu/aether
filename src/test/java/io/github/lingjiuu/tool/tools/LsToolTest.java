...
public class LsToolTest extends TestCase {
    ...
    public void testDescriptionNamesLimits() {
        String description = new LsTool(WorkspaceAccessPolicy.rootedAt(Path.of("."))).description();
    ...
    public void testListsDotfilesSortedAndMarksDirectories() throws Exception {
        ...
        ToolResultMessage result = execute(new LsTool(WorkspaceAccessPolicy.rootedAt(root)), "{\"path\":\".\"}");
    ...
    public void testReturnsEmptyDirectoryText() throws Exception {
        ...
        ToolResultMessage result = execute(new LsTool(WorkspaceAccessPolicy.rootedAt(root)), "{}");
    ...
    public void testReportsLimitNotice() throws Exception {
        ...
        ToolResultMessage result = execute(new LsTool(WorkspaceAccessPolicy.rootedAt(root)), "{\"limit\":1}");
    ...
    public void testRejectsOutsideRoot() throws Exception {
        ...
        ToolResultMessage result = execute(new LsTool(WorkspaceAccessPolicy.rootedAt(root)), "{\"path\":\"" + outside + "\"}");
