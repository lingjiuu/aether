...
public class FindToolTest extends TestCase {
    ...
    public void testDescriptionNamesLimits() {
        String description = new FindTool(WorkspaceAccessPolicy.rootedAt(Path.of("."))).description();
    ...
    public void testFindsBasenameAndPathGlobs() throws Exception {
        ...
        FindTool tool = new FindTool(WorkspaceAccessPolicy.rootedAt(root));
    ...
    public void testRespectsGitignorePatterns() throws Exception {
        ...
        ToolResultMessage result = execute(new FindTool(WorkspaceAccessPolicy.rootedAt(root)), "{\"pattern\":\"*.java\"}");
    ...
    public void testReportsMissingFd() throws Exception {
        ...
        FindTool tool = new FindTool(
                WorkspaceAccessPolicy.rootedAt(root),
